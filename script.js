...
function createChoroplethMap() {
   ...
   // Now add the title and bring it to the front
   ...
   svg.append("text")
     ...
     .style("fill", "gray")
     .text("A representation of income inequality across countries")
     .raise();
 
   // Legend positioning and bringing to front
   const legendWidth = 200, legendHeight = 10;
   const legend = svg.append("g").attr("transform", `translate(${width - legendWidth - 50}, 70)`).raise();
   ...
   legend.append("g").attr("transform", `translate(0,${legendHeight})`).call(legendAxis).raise();
